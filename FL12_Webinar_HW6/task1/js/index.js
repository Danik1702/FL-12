...
$('#title').css({'text-align': 'center', 'marginTop': '0px'});

// div after header: add double border and padding 20px

$('#header').next().css({'padding': '20px', 'border': '5px double #000'});

// change color for all h2 and set top margin to 0

$('h2').css({'color': '#666', 'marginTop': '0px'});
...
$('img').wrap('<div class="img-container"></div>').first().css({'float': 'left', 'border': '1px solid red'});
